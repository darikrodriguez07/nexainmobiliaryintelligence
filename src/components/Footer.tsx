      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-6 text-sm text-primary-foreground/50">
            <a href="https://docs.google.com/document/d/1dcqN41SNotUdZ7wJT5jUMPfbg561mExJcjUgl3_kGvc/edit?usp=sharing" target="_blank" className="hover:text-primary-foreground/80 transition-colors">Privacidad</a>
